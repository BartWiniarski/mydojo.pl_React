...
const UserAddDialogAdmin = ({ visible,
                                 onHide,
                                 user,
                                 onFormSubmit,
                                 onInputChange,
    ...
    return (
        <Dialog header="Dodawanie nowego użykownika" visible={visible} style={{width: '50vw'}} onHide={onHide}>
            <hr/>
            <div className="p-2">
...
export default UserAddDialogAdmin;
